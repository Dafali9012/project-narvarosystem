<template>
  <div class="d-flex flex-column align-items-center text-white">
    ...
    <div class="mt-5">
      ...
      <router-link to="/create-account" class="option d-flex align-self-center">
      ...
      <router-link to="/create-education" class="option d-flex align-self-center">
      ...
      <router-link to="/create-course" class="option d-flex align-self-center">
      ...
      <router-link to="/create-class" class="option d-flex align-self-center">
      ...
      <router-link to="/users" class="option d-flex align-self-center">
        <font-awesome-icon :icon="['fas','list']" class="align-self-center" />
