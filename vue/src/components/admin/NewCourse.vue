    ...
    <div class="main d-flex flex-column">
      ...
      <form>
        <div class="mt-5 d-flex justify-content-center">
          <input class="form-control" type="text" placeholder="Kursnamn" v-model="course.name" />
          <input class="form-control" type="number" placeholder="Poäng" v-model="course.point" />
        </div>
